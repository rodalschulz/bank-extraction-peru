...
def main():
    ...
    # Row 1: IBK --------------------------------------------------------------
    # Create a checkbox that reflects the state of ibk_df
    ...
    # Create a button that runs the ibk_extract function when clicked
    ...
    # Create a button to visualize the IBK DataFrame
    ...
    # Row 2: DIN --------------------------------------------------------------
    # Create a checkbox that reflects the state of din_df
    ...
    # Create a button that runs the din_extract function when clicked
    ...
    # Create a button to visualize the DIN DataFrame
    ...
    # Create a button that runs the din_extract function when clicked
    # test3button = ttk.Button(output_frame, text="User Config", command=lambda: open_test_gui())                        
    # test3button.grid(row=2, column=3, padx=(8, 8), pady=(0, 10))
    ...
    # Set default text for instructions
    default_text = """
    ...
    # Create a Label widget with default text (non-editable)
